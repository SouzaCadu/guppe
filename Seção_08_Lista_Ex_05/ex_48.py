"""
faça uma função que receba uma matriz 3 x 3 e calcule a soma dos elementos
...
def soma_acima_diagonal_principal(matriz):
    ...
    :return: Soma dos elementos que estão acima da diagonal principal
    """
    soma = 0
...
# print(matriz1)
print(soma_acima_diagonal_principal(matriz1))