"""
faça uma função que receba uma matriz 3 x 3 e calcule e retorne
...
def soma_diagonal_principal(matriz):
    ...
    :return: Soma dos elementos que estão na diagonal principal
    """
    soma = 0
...
# print(matriz1)
print(soma_diagonal_principal(matriz1))
